...
| `agent-skills-curated` | private-pre-public | MVP candidate batch, pre-adaptation review, MVP-02 transition gate, template-only adapted-output review checklist, bounded owner approval request, preflight record, post-approval execution plan, approval event, non-runtime adapted draft review, and MVP-03 preflight at `ebb914a...`; validation, topology, release-manifest check, 102 routing scenarios, and 182-test suite passed; remote `validate` success at `ebb914a...`, run `28272983350` |
...
| MVP-02 review, neutralize, and adapt | partial | pre-adaptation review evidence, bounded approval, non-runtime adapted drafts, checklist-based draft review evidence, and MVP-03 preflight exist; release payload, routing projection, runtime install, publication, and lifecycle feedback are still pending |
| MVP-03 deterministic release manifest | partial | release-or-routing preflight exists, but owner approval and candidate-specific release/routing disposition are pending |
